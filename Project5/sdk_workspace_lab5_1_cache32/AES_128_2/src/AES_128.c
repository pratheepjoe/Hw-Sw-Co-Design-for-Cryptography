 ...
 */
 ...
 // Multiplication LUT for 0x02 or {02}
...
void MixColumns(unsigned char StateArray[][4])
{
	...
	for(i=0; i<4; i++){
		for(i=0; i<4; i++){
				StateArrayTmp[0][i] =
						xTime2[StateArray[0][i]] ^ xTime3[StateArray[1][i]] ^ StateArray[2][i] ^ StateArray[3][i];
				StateArrayTmp[1][i] =
						StateArray[0][i] ^ xTime2[StateArray[1][i]] ^ xTime3[StateArray[2][i]] ^ StateArray[3][i];
				StateArrayTmp[2][i] =
						StateArray[0][i] ^ StateArray[1][i] ^ xTime2[StateArray[2][i]] ^ xTime3[StateArray[3][i]];
				StateArrayTmp[3][i] =
						xTime3[StateArray[0][i]] ^ StateArray[1][i] ^ StateArray[2][i] ^ xTime2[StateArray[3][i]];
	}
	}
