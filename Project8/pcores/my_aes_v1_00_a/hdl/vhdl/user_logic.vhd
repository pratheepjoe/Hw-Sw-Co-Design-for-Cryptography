...
-- Date:              Thu May 05 10:45:47 2011 (by Create and Import Peripheral Wizard)
...
component AES_component 
  ...
  signal sAES_Key, sAES_PT, sAES_CT : std_logic_vector (127 downto 0);

begin

  --USER logic implementation added here

sAES_Key <= slv_reg1&slv_reg2&slv_reg3&slv_reg4;
sAES_PT  <= slv_reg5&slv_reg6&slv_reg7&slv_reg8;

slv_reg9  <= sAES_CT(127 downto 96);
slv_reg10 <= sAES_CT(95 downto 64); 
slv_reg11 <= sAES_CT(63 downto 32);
slv_reg12 <= sAES_CT(31 downto 0);

AES_componnet_instance_0: AES_component 
    port map (clk         => Bus2IP_clk,
              AES_Control => slv_reg0,
	           AES_Key     => sAES_Key,
              AES_PT      => sAES_PT,
              AES_CT      => sAES_CT);
  ...
  SLAVE_REG_READ_PROC : process( slv_reg_read_sel, slv_reg0, slv_reg1, slv_reg2, slv_reg3, slv_reg4, slv_reg5, slv_reg6, slv_reg7, slv_reg8, slv_reg9, slv_reg10, slv_reg11, slv_reg12 ) is
  begin
