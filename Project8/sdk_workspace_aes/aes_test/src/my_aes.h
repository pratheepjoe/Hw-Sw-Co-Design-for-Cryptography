/*****************************************************************************
* Filename:          C:\Marcin\CCLI_AppliedCryptography\CourseMaterials\Week81_XPS_CustomComponent\ppc1/drivers/my_aes_v1_00_a/src/my_aes.h
* Version:           1.00.a
* Description:       my_aes Driver Header File
* Date:              Thu May 05 10:45:54 2011 (by Create and Import Peripheral Wizard)
*****************************************************************************/
...
#define MY_AES_mWriteSlaveReg0(BaseAddress, RegOffset, Value) \
 	XIo_Out32((BaseAddress) + (MY_AES_SLV_REG0_OFFSET) + (RegOffset), (Xuint32)(Value))
#define MY_AES_mWriteSlaveReg1(BaseAddress, RegOffset, Value) \
 	XIo_Out32((BaseAddress) + (MY_AES_SLV_REG1_OFFSET) + (RegOffset), (Xuint32)(Value))
#define MY_AES_mWriteSlaveReg2(BaseAddress, RegOffset, Value) \
 	XIo_Out32((BaseAddress) + (MY_AES_SLV_REG2_OFFSET) + (RegOffset), (Xuint32)(Value))
#define MY_AES_mWriteSlaveReg3(BaseAddress, RegOffset, Value) \
 	XIo_Out32((BaseAddress) + (MY_AES_SLV_REG3_OFFSET) + (RegOffset), (Xuint32)(Value))
#define MY_AES_mWriteSlaveReg4(BaseAddress, RegOffset, Value) \
 	XIo_Out32((BaseAddress) + (MY_AES_SLV_REG4_OFFSET) + (RegOffset), (Xuint32)(Value))
#define MY_AES_mWriteSlaveReg5(BaseAddress, RegOffset, Value) \
 	XIo_Out32((BaseAddress) + (MY_AES_SLV_REG5_OFFSET) + (RegOffset), (Xuint32)(Value))
#define MY_AES_mWriteSlaveReg6(BaseAddress, RegOffset, Value) \
 	XIo_Out32((BaseAddress) + (MY_AES_SLV_REG6_OFFSET) + (RegOffset), (Xuint32)(Value))
#define MY_AES_mWriteSlaveReg7(BaseAddress, RegOffset, Value) \
 	XIo_Out32((BaseAddress) + (MY_AES_SLV_REG7_OFFSET) + (RegOffset), (Xuint32)(Value))
#define MY_AES_mWriteSlaveReg8(BaseAddress, RegOffset, Value) \
 	XIo_Out32((BaseAddress) + (MY_AES_SLV_REG8_OFFSET) + (RegOffset), (Xuint32)(Value))
#define MY_AES_mWriteSlaveReg9(BaseAddress, RegOffset, Value) \
 	XIo_Out32((BaseAddress) + (MY_AES_SLV_REG9_OFFSET) + (RegOffset), (Xuint32)(Value))
#define MY_AES_mWriteSlaveReg10(BaseAddress, RegOffset, Value) \
 	XIo_Out32((BaseAddress) + (MY_AES_SLV_REG10_OFFSET) + (RegOffset), (Xuint32)(Value))
#define MY_AES_mWriteSlaveReg11(BaseAddress, RegOffset, Value) \
 	XIo_Out32((BaseAddress) + (MY_AES_SLV_REG11_OFFSET) + (RegOffset), (Xuint32)(Value))
#define MY_AES_mWriteSlaveReg12(BaseAddress, RegOffset, Value) \
 	XIo_Out32((BaseAddress) + (MY_AES_SLV_REG12_OFFSET) + (RegOffset), (Xuint32)(Value))

#define MY_AES_mReadSlaveReg0(BaseAddress, RegOffset) \
 	XIo_In32((BaseAddress) + (MY_AES_SLV_REG0_OFFSET) + (RegOffset))
#define MY_AES_mReadSlaveReg1(BaseAddress, RegOffset) \
 	XIo_In32((BaseAddress) + (MY_AES_SLV_REG1_OFFSET) + (RegOffset))
#define MY_AES_mReadSlaveReg2(BaseAddress, RegOffset) \
 	XIo_In32((BaseAddress) + (MY_AES_SLV_REG2_OFFSET) + (RegOffset))
#define MY_AES_mReadSlaveReg3(BaseAddress, RegOffset) \
 	XIo_In32((BaseAddress) + (MY_AES_SLV_REG3_OFFSET) + (RegOffset))
#define MY_AES_mReadSlaveReg4(BaseAddress, RegOffset) \
 	XIo_In32((BaseAddress) + (MY_AES_SLV_REG4_OFFSET) + (RegOffset))
#define MY_AES_mReadSlaveReg5(BaseAddress, RegOffset) \
 	XIo_In32((BaseAddress) + (MY_AES_SLV_REG5_OFFSET) + (RegOffset))
#define MY_AES_mReadSlaveReg6(BaseAddress, RegOffset) \
 	XIo_In32((BaseAddress) + (MY_AES_SLV_REG6_OFFSET) + (RegOffset))
#define MY_AES_mReadSlaveReg7(BaseAddress, RegOffset) \
 	XIo_In32((BaseAddress) + (MY_AES_SLV_REG7_OFFSET) + (RegOffset))
#define MY_AES_mReadSlaveReg8(BaseAddress, RegOffset) \
 	XIo_In32((BaseAddress) + (MY_AES_SLV_REG8_OFFSET) + (RegOffset))
#define MY_AES_mReadSlaveReg9(BaseAddress, RegOffset) \
 	XIo_In32((BaseAddress) + (MY_AES_SLV_REG9_OFFSET) + (RegOffset))
#define MY_AES_mReadSlaveReg10(BaseAddress, RegOffset) \
 	XIo_In32((BaseAddress) + (MY_AES_SLV_REG10_OFFSET) + (RegOffset))
#define MY_AES_mReadSlaveReg11(BaseAddress, RegOffset) \
 	XIo_In32((BaseAddress) + (MY_AES_SLV_REG11_OFFSET) + (RegOffset))
#define MY_AES_mReadSlaveReg12(BaseAddress, RegOffset) \
 	XIo_In32((BaseAddress) + (MY_AES_SLV_REG12_OFFSET) + (RegOffset))
